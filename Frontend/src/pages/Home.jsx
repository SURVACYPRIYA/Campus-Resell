...
import { ArrowRight, ShieldCheck, Zap, Users, MapPin, Award, HelpCircle, ShieldAlert } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
      {/* FULL BLEED HIGH RESOLUTION HERO BANNER */}
      <div style={{
        ...
        <div style={{
          ...
          width: '80%',
          height: '180%',
          background: 'radial-gradient(ellipse at center, rgba(193, 38, 50, 0.25) 0%, transparent 70%)',
          pointerEvents: 'none'
        }} />
        <div style={{
          position: 'absolute',
          ...
          width: '80%',
          height: '180%',
          background: 'radial-gradient(ellipse at center, rgba(254, 204, 47, 0.15) 0%, transparent 70%)',
          pointerEvents: 'none'
        }} />

        {/* Diamond Star Shape removed */}

{/* Flower decorative shape removed */}
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          >
            <Link to={user ? "/marketplace" : "/login"} style={{ 
              padding: '16px 45px', 
              fontSize: '1.1rem', 
              fontWeight: '700',
              borderRadius: '30px',
              ...
              color: '#ffffff',
              textDecoration: 'none',
              boxShadow: '0 4px 20px rgba(192, 37, 53, 0.45)',
      ...
      <footer style={{
        marginTop: '100px',
        background: '#262F4B url("https://images.unsplash.com/photo-1529429617-4e4e6c2a5d3b?w=1920") center/cover no-repeat',
        color: '#ffffff',
        display: 'flex',
        flexDirection: 'column',
        ...
        <div style={{
          ...
          <div>
            <img 
              ...
              alt="Campus Resell" 
              style={{ width: '180px', objectFit: 'contain', marginBottom: '20px', filter: 'brightness(0) invert(1)' }}
            />
            <p style={{ fontSize: '0.9rem', color: '#cbd5e1', lineHeight: '1.6' }}>
              Empowering students to trade, reuse, and save. Join the Campus Resell community today!
            </p>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              <li><a href="/contact" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.9rem', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <li><a href="/about" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.9rem', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Our Story</a></li>
              <li><a href="/team" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.9rem', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>Team</a></li>
              <li><a href="/faq" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.9rem', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#94a3b8'}>FAQ</a></li>
            </ul>
          </div>
